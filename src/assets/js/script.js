...
function new_pacode_btn(url){
    
    $("body").append('<div class="fixed-button active" id="new-pacde"><a href="'+url+'"  class="btn btn-md btn-primary"><i class="fa fa-file" aria-hidden="true"></i> New PA-CODE</a> </div>');var $window=$(window),nav=$(".fixed-button");
